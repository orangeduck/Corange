...
renderable* obj_load_file(char* filename) {
  ...
  while(SDL_RWreadline(file, line, 1024)) {
    ...
    int po1, po2, po3, po4, po5, po6, po7, po8, po9, po10, po11, po12;//'po' - polygon mode
    ...
    //converted polygons to triangles
    else if (sscanf(line, "f %i/%i/%i %i/%i/%i %i/%i/%i %i/%i/%i", &po1, &po2, &po3, &po4, &po5, &po6, &po7, &po8, &po9,&po10,&po11,&po12) == 12){
        /*--------------------------
         * input:
         * "f  a/a/a b/b/b c/b/c d/d/d"
         *--------------------------
         * output:
         * "f a/a/a b/b/b c/c/c"
         * "f a/a/a c/c/c d/d/d"
